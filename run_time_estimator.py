...
function updateStats(i) {{
  ...
  document.getElementById('stats-grid').innerHTML = `
    ...
    <div class="stat"><div class="stat-label">Objective / Wells / FOVs per well</div><div class="stat-value" style="font-size:14px">${{v.objective}} / ${{v.wells}}W / ${{v.fovs_per_well}} FOVs</div></div>
  `;
}}
